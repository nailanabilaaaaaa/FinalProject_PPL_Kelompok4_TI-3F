describe('Login', function (){
    ...
    it('Change Password Dengan Numerik', () => {  
        ...
        cy.get('#id_password').type('1941720068_')
        // Input Current Password
        cy.get('#id_newpassword1').type('1941720068')
        // Input New Password 1
        cy.get('#id_newpassword2').type('1941720068')
