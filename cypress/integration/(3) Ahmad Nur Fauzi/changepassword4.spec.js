describe('Login', function (){
    beforeEach(() => {        
        ...
        // Input Username
        cy.get('#password').type('Fauzi12345')
        // Input Password                
        cy.get('[class="btn btn-primary btn-block m-t-1"]').should('be.visible').click()   
        // Button Login
    })
    it('Change Password Dengan Numerik dan Special Character', () => {  
        ...
        cy.get('#id_password').type('Fauzi12345')
        // Input Current Password
        cy.get('#id_newpassword1').type('1941720068_')
        // Input New Password 1
        cy.get('#id_newpassword2').type('1941720068_')
